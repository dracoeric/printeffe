...
#    Updated: 2018/11/28 13:13:56 by erli             ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRCS		=		ft_printf.c		ft_conv_d.c		ft_put_format.c		\
					...
					ft_conv_c_ptrc.c				ft_conv_mat.c		\
					ft_conv_d_matd.c				ft_conv_d_matdh.c	\
					ft_conv_d_matdl.c				ft_conv_d_matdhh.c	\
					ft_conv_d_matdll.c				ft_conv_o_mato.c	\
					ft_conv_o_matol.c				ft_conv_o_matoll.c	\
					ft_conv_o_matoh.c				ft_conv_o_matohh.c	\
					ft_conv_f_matfl.c				ft_conv_f_matfbigl.c\
					ft_conv_c_matc.c				ft_conv_s_mats.c	\
					ft_conv_p_matp.c
