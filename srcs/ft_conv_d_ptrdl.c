...
/*   Updated: 2018/11/28 10:30:07 by erli             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		max_width(const t_format *format, long *tab, int len)
{
	int			width;
	long long	pow;
	int			i;
...
static	int		make_list_tmp(t_format *format, long *tab, int len,
					t_list **list_tmp)
{
	t_format	*format_tab;
	t_format	*copy;
