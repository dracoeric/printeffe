...
/*   Updated: 2018/11/28 12:17:22 by erli             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		make_list_tmp(t_format *format, unsigned long long **tab,
					int *dim, t_list **list_tmp)
{
	t_format	*format_tab;
	t_format	*copy;
	int			i;
...
{
	unsigned long long	**nb_tab;
	int					dim[2];
	t_list				*list_tmp;

	nb_tab = va_arg(ap, unsigned long long **);
	dim[0] = va_arg(ap, int);
	dim[1] = va_arg(ap, int);
	list_tmp = NULL;
