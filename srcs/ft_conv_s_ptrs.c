...
/*   Updated: 2018/11/28 14:28:26 by erli             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		max_width(const t_format *format, char **tab, int len)
{
	int			width;
	int			i;
	int			max;
...
static	int		make_list_tmp(t_format *format, char **tab, int len,
					t_list **list_tmp)
{
	t_format	*format_tab;
	t_format	*copy;
