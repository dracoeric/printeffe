...
/*   Updated: 2018/11/28 14:46:25 by erli             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static	int		max_width(const t_format *format, long long *tab, int len)
{
	int			width;
	long long	pow;
	int			i;
...
static	int		make_list_tmp(t_format *format, long long *tab, int len,
					t_list **list_tmp)
{
	t_format	*format_tab;
	t_format	*copy;
